 ...
 * @date	08/07/2013
 */
@Component("relatorioFrequenciasControlador")
@Scope("request")
public class RelatorioFrequenciasControlador implements IRelatorioControlador {

	private static String PAGINA_CORRENTE = "/paginas/adm/relatorioFrequencias.jsf?faces-redirect=true";
	...
	/**
	 * Este método prepara os filtros e parâmetros e emite o relatório de frequências.
	 * 
	 * @return String
	 */
	@Override
	public String emitirRelatorio() {
		try {
			exibirRelatorioSessao(servico.gerarRelatorioFrequencias(aluno, turma));
		} catch (Exception e) {
	...
	/**
	 * @return RelatorioFrequenciasControlador
	 */
	public static RelatorioFrequenciasControlador getInstancia() {
		return (RelatorioFrequenciasControlador) SpringContainer.getInstancia().getBean("relatorioFrequenciasControlador");
	}
